...
public class SymEncryption {
	public static void main(String[] args) throws Exception
	{
		...
		System.out.print("Plaintext : ");
	        for(byte b: plaintext.getBytes()) System.out.printf("%02X ", b);
	        System.out.print("\nPlaintext Length: "+ plaintext.getBytes().length+ " byte" );	
	        	
			byte[] ciphertext2 = cipher2.doFinal(plaintext.getBytes());
			System.out.print("\nCiphertext :");
